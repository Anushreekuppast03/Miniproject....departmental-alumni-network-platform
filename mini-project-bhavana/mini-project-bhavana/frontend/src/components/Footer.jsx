    ...
    <>
      <footer className={footerClasses}>
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
              ...
              <div className="text-${theme === 'dark' ? 'white' : 'black'}">(+91) 8192-223261</div>
            </div>
            <div className="col-lg-4 mr-auto text-center">
              <FaEnvelope className={iconClasses} />
              <a className="d-block" href="mailto:webmaster@bietdvg.eduk">webmaster@bietdvg.eduk</a>
            </div>
          </div>
        </div>
        <br />
        <div className="container">
          ...
          <div className={`small text-center text-${theme === 'dark' ? 'gray-400' : 'muted'}`}>
            Copyright © 2024 - CS BIET |  {devfooter} <a
              href="https://www.bietdvg.edu/"
              target="_blank"
              rel="noreferrer"
            >
              Biet.edu<GoVerified style={{ fontSize: "12px", marginLeft: "2px", color:"#03b3ff" }} />
            </a>
          </div>
        </div>
      </footer>
